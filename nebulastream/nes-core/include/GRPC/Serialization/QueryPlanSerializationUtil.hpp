...
#ifndef NES_CORE_INCLUDE_GRPC_SERIALIZATION_QUERYPLANSERIALIZATIONUTIL_HPP_
#define NES_CORE_INCLUDE_GRPC_SERIALIZATION_QUERYPLANSERIALIZATIONUTIL_HPP_
...
#endif// NES_CORE_INCLUDE_GRPC_SERIALIZATION_QUERYPLANSERIALIZATIONUTIL_HPP_
