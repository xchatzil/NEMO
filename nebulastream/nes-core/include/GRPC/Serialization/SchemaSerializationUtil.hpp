...
#ifndef NES_CORE_INCLUDE_GRPC_SERIALIZATION_SCHEMASERIALIZATIONUTIL_HPP_
#define NES_CORE_INCLUDE_GRPC_SERIALIZATION_SCHEMASERIALIZATIONUTIL_HPP_
...
#endif// NES_CORE_INCLUDE_GRPC_SERIALIZATION_SCHEMASERIALIZATIONUTIL_HPP_
