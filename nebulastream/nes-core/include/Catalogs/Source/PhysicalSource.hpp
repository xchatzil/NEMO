...
#ifndef NES_CORE_INCLUDE_CATALOGS_SOURCE_PHYSICALSOURCE_HPP_
#define NES_CORE_INCLUDE_CATALOGS_SOURCE_PHYSICALSOURCE_HPP_
...
#endif// NES_CORE_INCLUDE_CATALOGS_SOURCE_PHYSICALSOURCE_HPP_
