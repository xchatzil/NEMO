...
#ifndef NES_CORE_INCLUDE_OPTIMIZER_QUERYPLACEMENT_MINIMUMENERGYCONSUMPTIONSTRATEGY_HPP_
#define NES_CORE_INCLUDE_OPTIMIZER_QUERYPLACEMENT_MINIMUMENERGYCONSUMPTIONSTRATEGY_HPP_
...
class MinimumEnergyConsumptionStrategy : public BasePlacementStrategy {
  ...
  public:
    ...
    static std::unique_ptr<MinimumEnergyConsumptionStrategy> create(NESTopologyPlanPtr nesTopologyPlan) {
        return std::make_unique<MinimumEnergyConsumptionStrategy>(MinimumEnergyConsumptionStrategy(nesTopologyPlan));
    }
...
#endif// NES_CORE_INCLUDE_OPTIMIZER_QUERYPLACEMENT_MINIMUMENERGYCONSUMPTIONSTRATEGY_HPP_
