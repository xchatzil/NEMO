...
#ifndef NES_CORE_INCLUDE_OPTIMIZER_QUERYMERGER_HASHSIGNATUREBASEDPARTIALQUERYMERGERRULE_HPP_
#define NES_CORE_INCLUDE_OPTIMIZER_QUERYMERGER_HASHSIGNATUREBASEDPARTIALQUERYMERGERRULE_HPP_
