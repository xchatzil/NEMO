...
#ifndef NES_CORE_INCLUDE_OPTIMIZER_QUERYSIGNATURES_QUERYSIGNATUREUTIL_HPP_
#define NES_CORE_INCLUDE_OPTIMIZER_QUERYSIGNATURES_QUERYSIGNATUREUTIL_HPP_
...
#endif// NES_CORE_INCLUDE_OPTIMIZER_QUERYSIGNATURES_QUERYSIGNATUREUTIL_HPP_
