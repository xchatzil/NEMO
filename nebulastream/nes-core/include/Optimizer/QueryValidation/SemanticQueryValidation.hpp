...
#ifndef NES_CORE_INCLUDE_OPTIMIZER_QUERYVALIDATION_SEMANTICQUERYVALIDATION_HPP_
#define NES_CORE_INCLUDE_OPTIMIZER_QUERYVALIDATION_SEMANTICQUERYVALIDATION_HPP_
