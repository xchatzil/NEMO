...
#ifndef NES_CORE_INCLUDE_NODES_EXPRESSIONS_ARITHMETICALEXPRESSIONS_ROUNDEXPRESSIONNODE_HPP_
#define NES_CORE_INCLUDE_NODES_EXPRESSIONS_ARITHMETICALEXPRESSIONS_ROUNDEXPRESSIONNODE_HPP_
...
class RoundExpressionNode final : public ArithmeticalUnaryExpressionNode {
  public:
    ...
    ~RoundExpressionNode() noexcept final = default;
    /**
...
#endif// NES_CORE_INCLUDE_NODES_EXPRESSIONS_ARITHMETICALEXPRESSIONS_ROUNDEXPRESSIONNODE_HPP_
