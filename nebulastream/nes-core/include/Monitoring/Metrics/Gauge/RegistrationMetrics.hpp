...
#ifndef NES_CORE_INCLUDE_MONITORING_METRICS_GAUGE_REGISTRATIONMETRICS_HPP_
#define NES_CORE_INCLUDE_MONITORING_METRICS_GAUGE_REGISTRATIONMETRICS_HPP_
...
#endif// NES_CORE_INCLUDE_MONITORING_METRICS_GAUGE_REGISTRATIONMETRICS_HPP_
