...
*/
#ifndef NES_CORE_INCLUDE_QUERYCOMPILER_QUERYCOMPILER_HPP_
#define NES_CORE_INCLUDE_QUERYCOMPILER_QUERYCOMPILER_HPP_
...
#endif// NES_CORE_INCLUDE_QUERYCOMPILER_QUERYCOMPILER_HPP_
