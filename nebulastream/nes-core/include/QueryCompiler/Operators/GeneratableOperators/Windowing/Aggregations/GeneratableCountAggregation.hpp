...
#ifndef NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_AGGREGATIONS_GENERATABLECOUNTAGGREGATION_HPP_
#define NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_AGGREGATIONS_GENERATABLECOUNTAGGREGATION_HPP_
...
class GeneratableCountAggregation : public GeneratableWindowAggregation {
  public:
    ...
    ~GeneratableCountAggregation() noexcept override = default;
    /**
...
#endif// NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_AGGREGATIONS_GENERATABLECOUNTAGGREGATION_HPP_
