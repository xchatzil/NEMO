...
*/
#ifndef NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_KEYEDTIMEWINDOW_GENERATABLEKEYEDGLOBALSLICESTOREAPPENDOPERATOR_HPP_
#define NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_KEYEDTIMEWINDOW_GENERATABLEKEYEDGLOBALSLICESTOREAPPENDOPERATOR_HPP_
...
class GeneratableKeyedGlobalSliceStoreAppendOperator : public GeneratableOperator {
  public:
    /**
...
#endif// NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_KEYEDTIMEWINDOW_GENERATABLEKEYEDGLOBALSLICESTOREAPPENDOPERATOR_HPP_
