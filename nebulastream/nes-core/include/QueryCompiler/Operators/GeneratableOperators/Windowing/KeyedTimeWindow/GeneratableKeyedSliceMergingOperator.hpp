...
*/
#ifndef NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_KEYEDTIMEWINDOW_GENERATABLEKEYEDSLICEMERGINGOPERATOR_HPP_
#define NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_KEYEDTIMEWINDOW_GENERATABLEKEYEDSLICEMERGINGOPERATOR_HPP_
...
class GeneratableKeyedSliceMergingOperator : public GeneratableOperator {
  public:
    /**
...
#endif// NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_KEYEDTIMEWINDOW_GENERATABLEKEYEDSLICEMERGINGOPERATOR_HPP_
