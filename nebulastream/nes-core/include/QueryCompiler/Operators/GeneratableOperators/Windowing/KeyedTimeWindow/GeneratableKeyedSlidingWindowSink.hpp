...
*/
#ifndef NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_KEYEDTIMEWINDOW_GENERATABLEKEYEDSLIDINGWINDOWSINK_HPP_
#define NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_KEYEDTIMEWINDOW_GENERATABLEKEYEDSLIDINGWINDOWSINK_HPP_
...
class GeneratableKeyedSlidingWindowSink : public GeneratableOperator {
  ...
  private:
    GeneratableKeyedSlidingWindowSink(OperatorId id,
                                      ...
                                      std::vector<GeneratableOperators::GeneratableWindowAggregationPtr> windowAggregation);
    std::vector<GeneratableOperators::GeneratableWindowAggregationPtr> windowAggregation;
    Windowing::Experimental::KeyedSlidingWindowSinkOperatorHandlerPtr windowHandler;
};
}// namespace GeneratableOperators
}// namespace QueryCompilation
}// namespace NES

#endif// NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_KEYEDTIMEWINDOW_GENERATABLEKEYEDSLIDINGWINDOWSINK_HPP_
