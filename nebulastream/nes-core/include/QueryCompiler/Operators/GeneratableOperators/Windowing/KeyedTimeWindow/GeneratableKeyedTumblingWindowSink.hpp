...
*/
#ifndef NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_KEYEDTIMEWINDOW_GENERATABLEKEYEDTUMBLINGWINDOWSINK_HPP_
#define NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_KEYEDTIMEWINDOW_GENERATABLEKEYEDTUMBLINGWINDOWSINK_HPP_
...
class GeneratableKeyedTumblingWindowSink : public GeneratableOperator {
  public:
    /**
  ...
  private:
    GeneratableKeyedTumblingWindowSink(OperatorId id,
                                       SchemaPtr inputSchema,
                                       SchemaPtr outputSchema,
                                       Windowing::LogicalWindowDefinitionPtr& windowDefinition,
                                       std::vector<GeneratableOperators::GeneratableWindowAggregationPtr> windowAggregation);
...
#endif// NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_GENERATABLEOPERATORS_WINDOWING_KEYEDTIMEWINDOW_GENERATABLEKEYEDTUMBLINGWINDOWSINK_HPP_
