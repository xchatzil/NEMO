...
*/
#ifndef NES_CORE_INCLUDE_QUERYCOMPILER_PHASES_PHASEFACTORY_HPP_
#define NES_CORE_INCLUDE_QUERYCOMPILER_PHASES_PHASEFACTORY_HPP_
...
#endif// NES_CORE_INCLUDE_QUERYCOMPILER_PHASES_PHASEFACTORY_HPP_
