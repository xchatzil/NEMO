...
#ifndef NES_CORE_INCLUDE_QUERYCOMPILER_GENERATABLETYPES_BASICGENERATABLETYPE_HPP_
#define NES_CORE_INCLUDE_QUERYCOMPILER_GENERATABLETYPES_BASICGENERATABLETYPE_HPP_
