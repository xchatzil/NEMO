...
#ifndef NES_CORE_INCLUDE_OPERATORS_LOGICALOPERATORS_SINKS_NULLOUTPUTSINKDESCRIPTOR_HPP_
#define NES_CORE_INCLUDE_OPERATORS_LOGICALOPERATORS_SINKS_NULLOUTPUTSINKDESCRIPTOR_HPP_
...
class NullOutputSinkDescriptor : public SinkDescriptor {
  ...
  private:
    explicit NullOutputSinkDescriptor(FaultToleranceType::Value faultToleranceType, uint64_t numberOfOrigins);
};
...
#endif// NES_CORE_INCLUDE_OPERATORS_LOGICALOPERATORS_SINKS_NULLOUTPUTSINKDESCRIPTOR_HPP_
