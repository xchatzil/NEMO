...
#ifndef NES_CORE_INCLUDE_WINDOWING_WATERMARK_MULTIORIGINWATERMARKPROCESSOR_HPP_
#define NES_CORE_INCLUDE_WINDOWING_WATERMARK_MULTIORIGINWATERMARKPROCESSOR_HPP_
