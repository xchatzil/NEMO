...
#ifndef NES_CORE_INCLUDE_WINDOWING_WINDOWACTIONS_SLICEAGGREGATIONTRIGGERACTIONDESCRIPTOR_HPP_
#define NES_CORE_INCLUDE_WINDOWING_WINDOWACTIONS_SLICEAGGREGATIONTRIGGERACTIONDESCRIPTOR_HPP_
