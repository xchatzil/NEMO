...
function(llvmir_attach_bc_target)
  ...
  foreach(IN_FILE ${IN_FILES})
    ...
    add_custom_command(OUTPUT ${FULL_OUT_LLVMIR_FILE}
      ...
      ARGS ${CMD_ARGS} -S ${INFILE} -o ${FULL_OUT_LLVMIR_FILE}
      DEPENDS ${INFILE}
      IMPLICIT_DEPENDS ${LINKER_LANGUAGE} ${INFILE}
      COMMENT "Generating LLVM bitcode ${OUT_LLVMIR_FILE} : ${LLVMIR_COMPILER} ${CMD_ARGS} -S ${INFILE} -o ${FULL_OUT_LLVMIR_FILE}"
      VERBATIM)
...
function(llvmir_attach_link_target)
  ...
  add_custom_command(OUTPUT ${FULL_OUT_LLVMIR_FILE}
    ...
    -o ${FULL_OUT_LLVMIR_FILE} -S ${IN_FULL_LLVMIR_FILES}
