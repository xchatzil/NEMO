...
*/
#ifndef NES_RUNTIME_INCLUDE_EXPERIMENTAL_INTERPRETER_OPERATORS_AGGREGATION_AVGFUNCTION_HPP_
#define NES_RUNTIME_INCLUDE_EXPERIMENTAL_INTERPRETER_OPERATORS_AGGREGATION_AVGFUNCTION_HPP_
...
class AvgFunction : public AggregationFunction {
  public:
    AvgFunction(Runtime::Execution::Expressions::ExpressionPtr expression, Nautilus::IR::Types::StampPtr stamp);
...
#endif// NES_RUNTIME_INCLUDE_EXPERIMENTAL_INTERPRETER_OPERATORS_AGGREGATION_AVGFUNCTION_HPP_
